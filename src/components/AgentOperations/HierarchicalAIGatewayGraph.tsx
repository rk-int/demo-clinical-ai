  ...
  const nodes: Record<string, GatewayNodeDef> = {
    ai_gateway_ingress: {
      ...
      telemetry: {
        ...
        status: getNodeStatus(1),
        details: `User: ${currentUser?.name || 'Dr. Shalini Kapoor, MD, MD'} | Purpose: ${purposeOfUse} | TLS: 1.3 Strict`,
    ...
    hitl_physician_gate: {
      ...
      telemetry: {
        ...
        details: `Attending: ${currentUser?.name || 'Dr. Shalini Kapoor, MD, MD'} | State: Verified Physician Ingress`,
