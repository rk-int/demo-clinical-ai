...
export const HospitalBackgroundCanvas: React.FC<HospitalCanvasProps> = ({
  ...
  useEffect(() => {
    ...
    const characterPool: Character3D[] = [
      { x: 0.15, y: 0.72, z: 0.85, targetX: 0.8, speed: 0.35, direction: 1, role: 'ATTENDING_PHYSICIAN', coatColor: '#ffffff', scrubColor: '#0284c7', accentColor: '#38bdf8', stepPhase: 0, state: 'CONSULTING_HUD', interactionTimer: 120, name: 'Dr. Shalini Kapoor, MD, MD (Cardiology)', elevatedTier: 0 },
      { x: 0.45, y: 0.74, z: 0.9, targetX: 0.1, speed: 0.3, direction: -1, role: 'CHIEF_SURGEON', coatColor: '#f8fafc', scrubColor: '#7c3aed', accentColor: '#c084fc', stepPhase: 2.1, state: 'CONVERSATION', interactionTimer: 80, name: 'Dr. Madhavan Venkatesh, MD (Neurosurgery)', elevatedTier: 0 },
      { x: 0.48, y: 0.74, z: 0.9, targetX: 0.9, speed: 0.28, direction: 1, role: 'ICU_NURSE', coatColor: '#059669', scrubColor: '#10b981', accentColor: '#34d399', stepPhase: 4.2, state: 'CONVERSATION', interactionTimer: 80, name: 'Sunita Reddy, RN (Lead Triage)', elevatedTier: 0 },
      ...
      { x: 0.28, y: 0.70, z: 0.8, targetX: 0.7, speed: 0.22, direction: 1, role: 'PATIENT_WHEELCHAIR', coatColor: '#d97706', scrubColor: '#f59e0b', accentColor: '#fbbf24', stepPhase: 0, state: 'WALKING', interactionTimer: 0, name: 'Deepak Kumar (Patient • Suite 4B)', elevatedTier: 0 },
